...
/*新增评论接口*/
   ...
   /* 根据评论类型查询评论列表，并分页显示*/
    ...
    public Dto getCommentList(@RequestBody ItripSearchCommentVO vo) {
        ...
        /* 三元表达式：if(getPageNo==null){pageNo=1;}else{pageNo=2;}*/
                        ...
                        try {
                            ...
                            if (file != null) {
                                ...
                                if (myFileName.trim() != ""
                                    ...
                                    file.transferTo(localFile);/*该方法为为文件上传方法*/
                                    dataList.add("http://img" +
                                            ".itrip.project.bdqn.cn/comment/"+fileName);
                                }
                            }
                        } catch (Exception e) {
                            continue;
